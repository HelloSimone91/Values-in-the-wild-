...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div ref={panelRef} className="relative">
      <div className="absolute right-0 top-0 z-[70] flex flex-col items-end gap-3">
        ...
        {isOpen && activeSection && (
          <div className="w-[min(26rem,calc(100vw-2rem))] rounded-[1.8rem] border border-[var(--app-border)] bg-[var(--app-surface)] p-3 shadow-[0_24px_48px_var(--app-shadow-soft-strong)] backdrop-blur-xl">
            {activeSection === 'palette' && (
