  ...
  return (
    <div className="max-w-3xl mx-auto w-full pt-10 px-4">
      <div className="text-center mb-12 space-y-4">
        <h2 className="text-5xl font-black text-white tracking-tighter uppercase italic">Values Observation Log</h2>
        <p className="text-slate-300/70 text-lg font-light max-w-lg mx-auto leading-relaxed">
      ...
      <div className="bg-[#162940]/60 backdrop-blur-sm p-10 rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <textarea
          ...
          className="w-full h-40 p-8 bg-black/20 border border-white/5 rounded-[2rem] text-slate-100 placeholder:text-slate-600 focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500/30 resize-none transition-all font-medium text-lg leading-relaxed shadow-inner"
        />
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-4 px-10 py-5 bg-[#0d9488] text-white rounded-2xl font-black uppercase tracking-widest hover:bg-[#0f766e] disabled:bg-slate-800 disabled:text-slate-600 transition-all shadow-xl hover:scale-105 active:scale-95"
          >
