  ...
  return (
    <div className="max-w-6xl mx-auto w-full">
      <div className="mb-12 text-center lg:text-left">
        <h2 className="text-5xl font-black text-white tracking-tighter uppercase">Synthesis</h2>
        <p className="text-slate-300/80 text-xl font-light mt-3">Synthesizing patterns from your behavioral field notes.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-10">
          {/* Chart Card */}
          <div className="bg-[#162940]/60 backdrop-blur-sm p-10 rounded-[3rem] border border-white/10 shadow-2xl relative">
          ...
          {/* List Card */}
          <div className="bg-[#162940]/60 backdrop-blur-sm p-10 rounded-[3rem] border border-white/10 shadow-2xl max-h-[500px] overflow-y-auto">
             ...
             {entries.length === 0 ? (
               ...
               <ul className="space-y-6">
                 {entries.slice().reverse().map((entry) => (
                   <li key={entry.id} className="bg-white/5 p-6 rounded-[2rem] border border-white/5 hover:border-teal-500/30 transition-all duration-300 group">
                     <div className="flex justify-between items-start mb-3">
                       <span className="font-black text-xl text-white group-hover:text-teal-400 transition-colors uppercase tracking-tight">{entry.value}</span>
        ...
        <div className="flex flex-col h-full">
          <div className="bg-gradient-to-br from-teal-500/20 to-amber-500/20 rounded-[3.5rem] p-[1px] h-full shadow-2xl">
            <div className="bg-[#111d2e] rounded-[3.4rem] p-12 h-full flex flex-col">
              <div className="flex items-center justify-between mb-10">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-6 py-3 bg-[#0d9488] text-white rounded-xl font-black uppercase tracking-widest hover:bg-[#0f766e] transition-all disabled:opacity-20 flex items-center gap-3 text-xs"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-amber-500/90 text-[#111d2e] rounded-xl font-black uppercase tracking-widest hover:bg-amber-400 transition-all disabled:opacity-20 text-xs"
                  >
                    Build 7-Day Plan
                  </button>
                </div>
              ...
              <div className="flex-1 rounded-[2rem] overflow-y-auto scrollbar-hide bg-black/10 p-8 border border-white/5">
                {isGenerating ? (
